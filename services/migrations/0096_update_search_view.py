...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("services", "0095_create_unit_search_column_fi_without_syllables"),
    ]
    operations = [
        migrations.RunSQL(
            sql="""
            ...
            SELECT concat('unit_', services_unit.id) AS id, name_fi, name_sv, name_en, search_column_fi, search_column_sv, search_column_en, search_column_fi_without_syllables, 'Unit' AS type_name from services_unit
            UNION
